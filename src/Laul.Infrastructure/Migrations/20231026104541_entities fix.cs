    ...
    public partial class entitiesfix : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikeDislikes", x => new { x.UserId, x.SongId });
                    table.ForeignKey(
                        name: "FK_LikeDislikes_Songs_SongId",
                        column: x => x.SongId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ListeningStats_Songs_SongId",
                        column: x => x.SongId,
                        principalTable: "Songs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LikeDislikes_SongId",
                table: "LikeDislikes",
                column: "SongId");

            migrationBuilder.CreateIndex(
                name: "IX_ListeningStats_SongId",
                table: "ListeningStats",
                column: "SongId");
